...
class User {#
    ...
    # cmpPass = pw => Result.fromBool(this.#password === pw, this, { senha: 'Incorrect Password' })
    cmpPass = user => user.#cmpPass(this.#password)
...
class LoginView {#
    ...
    initialize() {
        ...
        this.#root.getElement('#senha').maxlength = 64;

        this.#dyn = {
            email: this.#root.getElement('#email'),
            senha: this.#root.getElement('#senha'),
            submitLogin: this.#root.getElement('#submitlogin'),
            submitSignup: this.#root.getElement('#submitsignup'),
            closeform: this.#root.getElement('#closeform'),
            emailErr: this.#root.getElement('#emailerr'),
            senhaErr: this.#root.getElement('#senhaerr')
        }
